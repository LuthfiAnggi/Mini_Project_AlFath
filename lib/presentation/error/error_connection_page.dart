...
import 'package:mini_project1/presentation/work/bloc/job_list/job_list_event.dart';
import '../work/bloc/job_list/job_list_bloc.dart'; // <-- 2. IMPORT BLOC ANDA
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(Assets.images.imgErorrConnection.path,
            height: 220 ,
            width: 220,
            ),
