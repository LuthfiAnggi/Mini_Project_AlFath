...
import 'package:mini_project1/presentation/auth/page/auth_options_page.dart'; // Ganti 'mini_project1' dengan nama proyek Anda
      ...
      body: Stack(
        children: [
          ...
          _BuildBackground(
            ...
            // Ini halaman 2, jadi kita panggil ilustrasi 4
            illustrationAsset: Assets.images.imgIllustration4,
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Text(
                    "Ayo Mulai Karir Impian\nAnda", // Teks baru
                    style: Theme.of(context).textTheme.titleLarge,
                    textAlign: TextAlign.center,
                  ),
                  const SizedBox(height: 16),
                  Text(
                    "Ikuti pelatihan dan dapatkan panduan untuk meraih pekerjaan atau promosi yang Anda inginkan.", // Teks baru
