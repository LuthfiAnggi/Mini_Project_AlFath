...
import 'package:mini_project1/presentation/onboarding/page/onboarding4_page.dart'; // Ganti 'mini_project1' dengan nama proyek Anda
      ...
      body: Stack(
        children: [
          ...
          _BuildBackground(
            ...
            // Ini halaman 2, jadi kita panggil ilustrasi 3
            illustrationAsset: Assets.images.imgIllustration3,
          ),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Text(
                    "Dapatkan Bimbingan Langsung", // Teks baru
                    style: Theme.of(context).textTheme.titleLarge,
                    textAlign: TextAlign.center,
                  ),
                  const SizedBox(height: 16),
                  Text(
                    "Belajar dari mentor berpengalaman yang siap membantu Anda memahami materi lebih\ndalam.", // Teks baru
